...
<nav
  ...
  class="sticky top-0 left-0 z-50 bg-[var(--headerBackground)]/50 backdrop-blur-md border-b border-t border-[var(--lineColor)] shadow-sm overflow-x-scroll lg:overflow-x-auto"
>
